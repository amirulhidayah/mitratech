...
<form action="{{ route('paket.update',$paket->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group @error('nama') has-error @enderror">
        ...
        <input type="text" value="{{ $paket->nama }}" class="form-control" name="nama" placeholder="Masukkan Nama"
            required>
        @error('nama')
    ...
    <div class="form-group @error('harga') has-error @enderror">
        ...
        <input type="text" value="{{ $paket->harga }}" class="form-control" name="harga" placeholder="Masukkan Harga"
            required>
        @error('harga')
        <small class="form-text text-danger">{{ $message }}</small>
        @enderror
    ...
    <div class="form-group" id="fitur">
        ...
        <div class="row my-2" id="daftarFitur{{ $loop->iteration }}"><input type="text" value="{{$fitur->fitur}}"
                class="form-control" name="fitur[]" placeholder="Masukkan Fitur" hidden>
            <div class="col-lg-11">
                <p>{{$fitur->fitur}}</p>
    ...
    <div class="form-group @error('urutan') has-error @enderror">
        ...
        <input type="number" value="{{ $paket->urutan }}" class="form-control" name="urutan"
