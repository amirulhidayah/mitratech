...
@section('content')
    <form action="{{ route('tim.update', $tim->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group @error('nama') has-error @enderror">
            ...
            <input type="text" value="{{ $tim->nama }}" class="form-control" name="nama" placeholder="Masukkan Nama">
            @error('nama')
                <small class="form-text text-danger">{{ $message }}</small>
            @enderror
        </div>
        <div class="form-group @error('posisi') has-error @enderror">
            <label for="errorInput">Posisi</label>
            <input type="text" value="{{ $tim->posisi }}" class="form-control" name="posisi" required
        ...
        <div class="form-group @error('urutan') has-error @enderror">
            ...
            <input type="number" value="{{ $tim->urutan }}" class="form-control" name="urutan" required
        ...
        <div class="form-group @error('foto') has-error @enderror">
            ...
            <div id='img_contain'><img id="blah" align='middle' src="/assets/welcome/img/teams/{{ $tim->foto }}" alt=""
                    title='' /></div>
